...
//					  }
		...
		btnLoad = new JButton();
		btnLoad.setToolTipText("Load history");
		btnSave = new JButton();
		btnSave.setToolTipText("Save history");
	...
	public void parseSelectedFile(String pathToFile){
		...
		if (pathToFile != null) {
			...
			try {
			    ...
			    KrokiMockupToolApp.getInstance().displayTextOutput("Imported file " + pathToFile, OutputPanel.KROKI_RESPONSE);
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
